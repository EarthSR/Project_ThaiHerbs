...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="content-container">
        ...
        <div class="login">
            <asp:Label ID="LabelSignIn" runat="server" Text="SIGN IN" CssClass="login-text">
            </asp:Label>
            <br />
            <br />
            <div class="log">
                <p class="textregister">
                    <asp:Label ID="lblusername" runat="server" Text="Username" CssClass="login-text">
                    </asp:Label>
                </p>
                <p>
                    <asp:TextBox ID="txtusername" runat="server" Height="26px" Width="190px" CssClass="designbox">
                    </asp:TextBox>
                </p>
                <p>
                ...
                <p class="textregister">
                    <asp:Label ID="lblpassword" runat="server" Text="Password" CssClass="login-text">
                    </asp:Label>
                </p>
                <p>
